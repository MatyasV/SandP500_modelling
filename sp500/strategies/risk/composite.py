"""Risk composite strategy — weighted blend of multiple risk measures."""
...
class RiskCompositeStrategy(BaseStrategy):
    ...
    @property
    def name(self) -> str:
        return "risk_composite"

    @property
    def description(self) -> str:
        return "Weighted composite of risk measures"
    ...
    def analyze(self, ticker: str, data: dict[DataField, Any]) -> StrategyResult | None:
        ...
        raise NotImplementedError("RiskCompositeStrategy requires analyze_all()")
    ...
    def analyze_all(self, all_data: dict[str, dict[DataField, Any]]) -> list[StrategyResult]:
        ...
        # strategy_results[strategy_name][ticker] = StrategyResult
