"""Growth Composite strategy — weighted blend of growth metrics."""
...
class GrowthCompositeStrategy(BaseStrategy):
    ...
    def description(self) -> str:
        return "Weighted composite of growth metrics"
    ...
    def analyze(self, ticker: str, data: dict[DataField, Any]) -> StrategyResult | None:
        ...
        raise NotImplementedError("GrowthCompositeStrategy requires analyze_all()")
